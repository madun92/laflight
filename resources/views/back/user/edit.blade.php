...
<div class="col-lg-6">
    <div class="panel ">
        ...
        <div class="panel-body">
            <form action="{{ route('user.update',  ['id' => $user->id]) }}" class="form-horizontal" method="POST">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                id="inputUsername2" placeholder="Name" name="name" value="{{ $user->name }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"
                                placeholder="Address" id="inputAddress2" name="address" value="{{ $user->address }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
